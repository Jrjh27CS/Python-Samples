...
#Challenge is to accept a single number and check if it's odd or even
...
#Extra 1 was to check if number was divisible by 4 so modulus again
remSpec = num1 % 4
if remSpec == 0:
    print("Your num was divisible by 4")
#Extra 2 was to check whether your first number is evenly divisible by your second number.
rem = num1 % num2
if rem == 0:
